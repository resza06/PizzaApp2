            ...
            buttonShop.setOnClickListener {
                ...
                if (jumlahData == 0) {
                    ...
                    val cek = TransaksiAdapter.listId.find { data ->
                        textId.text.toString().toInt().equals(data)
                    }
                    ...
                    if (cek == null) {
                        ...
                        var indek: Int =
                            TransaksiAdapter.listId.indexOf(textId.text.toString().toInt())
                        val qty: Int = TransaksiAdapter.listJumlah[indek] + 1
                        TransaksiAdapter.listJumlah.set(indek, qty)
                        TransaksiAdapter.harga =
                            TransaksiAdapter.harga + TransaksiAdapter.listHarga[indek]
                        Toast.makeText(v.context, "Purchase Order Success", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
